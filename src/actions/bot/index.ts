          ...
          messages: [
            {
              ...
              if the customer agrees to book an appointment send them this link ${process.env.NEXT_PUBLIC_PRODUCTION_URL}/portal/${id}/appointment/${
                checkCustomer?.customer[0].id
              }

              if the customer wants to buy a product redirect them to the payment page ${process.env.NEXT_PUBLIC_PRODUCTION_URL}/portal/${id}/payment/${
                checkCustomer?.customer[0].id
              }
          `,
            },
